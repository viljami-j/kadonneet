...
import com.ihmistenit.kadonneet.ui.user_advert.UserAdvertsFragment


class MainActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMainBinding
    private lateinit var appBarConfiguration: AppBarConfiguration
    private fun evaluateThemePreference(newVal: Any): Boolean {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val userAdvertRecyclerView: Fragment? = supportFragmentManager.findFragmentById(R.id.tabContentFragContainer)//?.view?.findViewById(R.id.user_advert_recyclerview)
        ...
        setupReportFindingFab()
    }

    private fun setupReportFindingFab() {
    ...
    private fun setupBottomNavigation() {
        ...
        val navHostFragment =
            supportFragmentManager.findFragmentById(R.id.nav_host_fragment_bottom_nav) as NavHostFragment
